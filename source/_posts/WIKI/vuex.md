...
categories:
  - WIKI
keywords: 'Vue,Vuex,javascript'
description: Vuex 是一个专为 Vue.js 应用程序开发的状态管理模式。它采用集中式存储管理应用的所有组件的状态，并以相应的规则保证状态以一种可预测的方式发生变化。
cover: https://cdn.jsdelivr.net/gh/seiwhale/assets/img/vue_plugin.jpg
---
...
![flow.png](https://upload-images.jianshu.io/upload_images/14272773-c844bf0476fc9e1a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![vuex.png](https://upload-images.jianshu.io/upload_images/14272773-43c1c773191169aa.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
